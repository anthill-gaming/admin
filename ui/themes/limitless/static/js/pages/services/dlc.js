$(function () {
    ...
    // Initialize
    var datatable = $('.table-bundles').DataTable({
        autoWidth: false,
        columnDefs: [
            {
                targets: 0,
        ...
        language: {
            search: '<span>Search bundle:</span> _INPUT_',
        ...
        buttons: [
            {
                text: 'Create bundle <i class="icon-plus22 position-right"></i>',
    ...
    // Remove bundle
    $(document).on('click', '.table-bundles .remove-bundle-action', function (e) {
        e.preventDefault();
        var row = $(this).closest('tbody tr');
        swal({
                title: "Are you sure?",
                text: "Bundle will be removed.",
                type: "warning",
