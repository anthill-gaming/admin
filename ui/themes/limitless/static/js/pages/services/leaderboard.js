$(function () {
    ...
    var datatable = $('.table-records').DataTable({
        ...
        language: {
            search: '<span>Search record:</span> _INPUT_',
        ...
        buttons: [
            {
                text: 'Create record <i class="icon-plus22 position-right"></i>',
    ...
    // Remove record
    $(document).on('click', '.table-records .remove-record-action', function (e) {
        e.preventDefault();
