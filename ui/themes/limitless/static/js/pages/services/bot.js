$(function () {
    ...
    // Initialize
    var datatable = $('.table-bots').DataTable({
        autoWidth: false,
        columnDefs: [
            {
                targets: 0,
        ...
        language: {
            search: '<span>Search bot:</span> _INPUT_',
        ...
        buttons: [
            {
                text: 'Create bot <i class="icon-plus22 position-right"></i>',
    ...
    // Remove bot
    $(document).on('click', '.table-bots .remove-bot-action', function (e) {
        e.preventDefault();
        var row = $(this).closest('tbody tr');
        swal({
                title: "Are you sure?",
                text: "Bot will be removed.",
                type: "warning",
