$(function () {
    ...
    // Initialize
    var datatable = $('.table-services').DataTable({
        autoWidth: false,
        columnDefs: [
            {
                targets: 0,
        ...
        language: {
            search: '<span>Search service:</span> _INPUT_',
        ...
        buttons: [
            {
                text: 'Create service <i class="icon-plus22 position-right"></i>',
    ...
    // Remove user
    $(document).on('click', '.table-services .remove-service-action', function (e) {
        e.preventDefault();
        var row = $(this).closest('tbody tr');
        swal({
                title: "Are you sure?",
                text: "Service will be removed.",
                type: "warning",
