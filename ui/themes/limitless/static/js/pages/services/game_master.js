$(function () {
    ...
    var datatable = $('.table-deployments').DataTable({
        ...
        language: {
            search: '<span>Search deployment:</span> _INPUT_',
        ...
        buttons: [
            {
                text: 'Create deployment <i class="icon-plus22 position-right"></i>',
    ...
    // Remove store item
    $(document).on('click', '.table-deployments .remove-deployment-action', function (e) {
        e.preventDefault();
        var row = $(this).closest('tbody tr');
        swal({
                title: "Are you sure?",
                text: "Deployment will be removed.",
                type: "warning",
            ...
            function (isConfirm) {
                if (isConfirm) {
                    setTimeout(function() {
                        swal({
                            title: "Removed!",
                            text: "Deployment has been removed.",
