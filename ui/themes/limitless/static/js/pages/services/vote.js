$(function () {
    ...
    // Initialize
    var datatable = $('.table-votes').DataTable({
        autoWidth: false,
        columnDefs: [
            {
                targets: 0,
        ...
        language: {
            search: '<span>Search vote:</span> _INPUT_',
        ...
        buttons: [
            {
                text: 'Create vote <i class="icon-plus22 position-right"></i>',
    ...
    // Remove vote
    $(document).on('click', '.table-votes .remove-vote-action', function (e) {
        e.preventDefault();
        var row = $(this).closest('tbody tr');
        swal({
                title: "Are you sure?",
                text: "Vote will be removed.",
                type: "warning",
